      ...
      {fields.map((field, index) => (
        <div key={field.id} className="grid grid-cols-12 gap-4 py-1 px-4 bg-white even:bg-gray-50 items-center group">
          ...
          <div className="col-span-2">
            <input {...register(`items.${index}.quantity`)} type="number" className="w-full bg-transparent" />
          </div>
          <div className="col-span-2">
            <input {...register(`items.${index}.rate`)} type="number" step="0.01" className="w-full bg-transparent" />
          </div>
